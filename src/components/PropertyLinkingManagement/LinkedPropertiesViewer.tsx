    ...
    <div className="bg-white rounded-2xl p-4 md:p-8 shadow-lg border border-gray-100">
      ...
      {linkedProperties && !loadingLinkedProperties && (
        <div className="space-y-6">
          {(() => {
            // All properties in the response should be constituents with the same masterPropertyId
            const constituentProperties = linkedProperties.filter(
              (prop) => prop.propertyLinkType === "constituent"
            );
            // Get the master property ID from the first constituent
            const masterPropertyId = constituentProperties[0]?.masterPropertyId;
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs md:text-sm text-gray-600">
                            {constituentProperties.length} properties are linked
