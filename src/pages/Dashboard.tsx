              ...
              <div className="flex items-center gap-2.5">
                <button
                  ...
                  className={`text-sm p-2 ${
                    selected === 0
                      ? "font-medium text-[#121212] rounded-lg border bg-[#FAFAFA]"
                      : "text-[#808080]"
                  }`}
                >
                  Overview
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 w-full gap-4">
                    <div className="bg-[linear-gradient(220deg,_#D5FFE7,_#FFFF_45%)] border shadow-sm rounded-xl space-y-6 p-4">
                      <div className="w-full flex items-center justify-between">
                        <h4 className="text-[#808080] font-medium">Booked</h4>
                        <h6 className="text-[#219653] font-medium text-sm">
                          +200%
                        </h6>
                      </div>
                      <div>
                    ...
                    <div className="bg-[linear-gradient(220deg,_#FFEEEE,_#FFFF_45%)] border shadow-sm rounded-xl space-y-6 p-4">
                      <div className="w-full flex items-center justify-between">
                        <h4 className="text-[#808080] font-medium">Occupied</h4>
                        <h6 className="text-[#E90000] font-medium text-sm">
                          +200%
                        </h6>
                      </div>
                      <div>
                    ...
                    <div className="bg-[linear-gradient(220deg,_#D5FFE7,_#FFFF_45%)] border shadow-sm rounded-xl space-y-6 p-4">
                      <div className="w-full flex items-center justify-between">
                        <h4 className="text-[#808080] font-medium">Vacant</h4>
                        <h6 className="text-[#219653] font-medium text-sm">
                          +200%
                        </h6>
                      </div>
